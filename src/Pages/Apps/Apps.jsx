...
const Apps = () => {
    ...
    return (
       <>
        ...
        <div className='flex justify-between items-center p-5 sm:w-[1440px] w-full mx-auto '>
            <div>
                <p className='font-semibold text-2xl'>({filterApps.length})Apps Found</p>
            </div>
            <div>
               
                <input onChange={handleSearch} className='border-1 border-gray-200 sm:w-[400px] h-[44px] bg-no-repeat bg-left  bg-[length:16px_16px] pl-8 ' style={{backgroundImage:`url(${search})`, backgroundPosition:'10px'}} type="search" name="" id="" placeholder= 'Search Apps' />
            </div>

            
        </div>

        <div className='sm:w-[1440px] h-auto   mx-auto p-5'>
