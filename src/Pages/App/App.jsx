...
const App = ({allApp}) => {
    ...
    return (
        <div>
            ...
            <div className='w-[348px] h-[435px] border border-gray-300 shadow-md rounded-sm mt-5 transform transition-transform duration-150  hover:-translate-y-4 active:scale-95'>
