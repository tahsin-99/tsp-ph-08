...
const Footer = () => {
    return (
        ...
        <h2 className='text-2xl font-bold mb-4'>Appify.Io</h2>
       ...
       <p className='text-gray-500'>Privacy Policy</p>
        ...
        <p className='text-gray-500'>Join Us </p>
           ...
           <div className='text-gray-500 space-y-2'>
             <img src={xImg} alt="" /><a href="https://x.com/">Appify System</a>
            <img src={inImg} alt="" /><a href="https://www.linkedin.com/">Appify System</a>
            <img src={fImg} alt="" /><a href="https://www.facebook.com/">Appify System</a>
        ...
        <div >
            <p className=' text-gray-400  text-[16px] text-center mb-8'>
                © 2025 Appify.Io. All rights reserved.
            </p>
        </div>
        </footer>
